@echo off
REM ========================================================================
REM P_020 Full Workflow - UTF-8 FIX
REM ========================================================================
REM This version sets UTF-8 encoding to handle Unicode characters
REM ========================================================================

REM Set UTF-8 encoding for this session
chcp 65001 >nul
...
echo.
echo ========================================================================
echo   P_020 FULL WORKFLOW - UTF-8 VERSION
echo ========================================================================
echo.
...
for %%f in ("%TOS_FOLDER%\%FILE_PREFIX%*AccountStatement*.csv") do (
    ...
    if errorlevel 1 (
        ...
        set "LATEST_FILE=%%f"
        echo   [OK] This is a TOS export file! Will use this one.
    ) else (
        echo   [SKIP] Contains _IMPORT, skipping (this is parser output)
    )
)
...
REM Set UTF-8 for "C:\Users\Trader\.conda\envs\p140\python.exe" output too
...
if errorlevel 1 (
    ...
    echo ========================================================================
    echo.
    echo The parser encountered an error.
...
echo.
echo [OK] Parser completed successfully!
echo.
