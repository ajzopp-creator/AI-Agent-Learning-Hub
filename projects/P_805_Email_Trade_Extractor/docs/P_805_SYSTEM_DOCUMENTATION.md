...
7.  **~~Outlook retention policy.~~** DONE (2026-09-06). Same 10-day rule applied to Outlook's `ExtractedNewsletterFolder`. All four accounts now covered.
