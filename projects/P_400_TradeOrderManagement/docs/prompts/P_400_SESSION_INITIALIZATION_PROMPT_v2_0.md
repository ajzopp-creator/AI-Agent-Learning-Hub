# P_400 Session Initialization Prompt v2.2
**Ref:** Architecture v2.1 | Last Updated: 2026-06-18
...
```
Tony pastes output. Ask: "Which PASS signals — Tier 2A (full dossier) or Tier 2B (straight-to-trade)?"
...
Build: trend > S/R > MAs > RSI > MACD > BB > volume > Fib > pattern > trade plan
...
---
*Owner: Anthony Zoppi | 2026-06-18 | v2.2*