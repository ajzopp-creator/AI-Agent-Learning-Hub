...
This version removes the ambiguity around **Mark** and makes the trigger definition depend on the trade plan itself, which is what you wanted. It also preserves your rule that option exits should be managed from the underlying stock trigger, while using bid-aware pricing when spreads are wide.[^1][^2][^3]

[^1]: https://www.perplexity.ai/search/adab3def-e405-4732-b2fa-01927316ae39

[^2]: https://www.perplexity.ai/search/0054d571-ee6d-4eba-baff-e556066d47f0

[^3]: https://www.perplexity.ai/search/e6b812c3-3aec-4f49-8d4c-937609b4777d

## Best use

Paste the lock line first, then the prompt, then the trade setup. That makes the order of operations much clearer and reduces the chance of drifting away from your target output.[^4]

[^4]: P_400-Perplexity-Master-Trade-SetUp-Prompt_v1.1.md
