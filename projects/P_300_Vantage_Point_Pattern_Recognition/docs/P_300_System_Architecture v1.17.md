...
| EC-055 | | Fixed | Workflow Disparity Rule: Add Pattern = Sequential (Safe Write); Daily Eval = Integrated (Fast Read). Keep PowerShell and Python roles distinct.
