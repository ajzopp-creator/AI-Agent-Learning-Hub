...
### **Workflow Steps**
** Pipeline A: The Brain Vault (New Historical Ingest) **
Source Folder: data\historical_patterns\
Filename Rule: Must start with Pattern_.
Process: batch_ingest_orchestrator.py
Workflow: Read → Integrity Check → Archive to data\archive\.
** Pipeline B: Daily Pattern Analysis (Operational Standard)**
Keep your existing "Step 1 — Ingest" through "Folder Roles" tables exactly as you provided them. (This ensures your PowerShell wrappers like P_300_00_WorkflowLauncher.ps1 remain the master record).
