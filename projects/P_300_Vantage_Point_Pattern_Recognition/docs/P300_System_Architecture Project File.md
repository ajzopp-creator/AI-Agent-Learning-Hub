...
- v1.2 — 2026-04-25  \n  - Added POC Drift Guardrail requiring exact SPY-first POC cloning unless deviations are explicitly approved and documented.  \n  - Updated session initialization prompt to force drift flagging for new parser, schema, workflow, or generalized approaches.


## Version History

- 2026-04-25  
  - FR-5 scaffold validated on QQQ 5-day and 7-day files.  
  - Remaining dependency: QQQ 10-day file for full hold-window validation and completion.
