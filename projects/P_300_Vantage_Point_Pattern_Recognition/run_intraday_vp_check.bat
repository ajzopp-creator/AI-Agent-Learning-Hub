@echo off
REM P_300 Intraday VP Band Check
...
echo.
echo ================================================================================
echo P_300 INTRADAY VP BAND CHECK
echo Time: %date% %time%
...
"C:\Users\Trader\.conda\envs\p140\python.exe" "python\P_300_Intraday_VPCheck_v2.6.py" >> "%logfile%" 2>&1
