"""
PEH handoff script -- run P_400's known-bugs regression suite after
WO-P000-E10.001 Phase 2 items 2.1 and 2.2 (9 new tests total: 4 for 2.1,
5 for 2.2). Self-contained; writes its own .done marker on exit.
"""
