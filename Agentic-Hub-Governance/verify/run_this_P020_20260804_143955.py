"""
PEH handoff script -- run the two new WO-P000-E10.001 Phase 1 regression
tests for P_020. Self-contained; writes its own .done marker on exit
(peh-handoff v1.4 -- ref WO-P000-E12.001).
"""
